...
import { addExpenseSlice, updateExpenseSlice } from "../redux/ExReducer";
...
import DailyExpDisplayRedux from "./DailyExDisplayRedux";

export default function DailyExpRedux(props) {
  const email = useSelector((state) => state.auth.email);

  const firebaseDB = `https://profile-8d013-default-rtdb.firebaseio.com/${email.replace(
    /[.@]/g,
    ""
  )}`;
